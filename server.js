...
// --- Service Imports ---
const initializeDatabase = require('./db/sequelize'); // <-- NEW DB INITIALIZER
...
async function startServer() {
    ...
    const { Application } = await initializeDatabase();
    ...
    app.use('/', applicationsRouter({ Application, ai, upload, fs, runScraper, sendDailyDigest })); 
